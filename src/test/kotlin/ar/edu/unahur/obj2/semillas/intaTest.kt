...
class intaTest: DescribeSpec({
    describe("test INTA"){
        ...
        val parcela12 = ParcelasEcologicas(17.0, 1.0, 6, mutableListOf(menta1, peperina3, menta2, quinoa1, peperina2, soja1, soja2))
        val parcela13 = ParcelasEcologicas(2.0, 4.0, 4, mutableListOf(menta1, peperina3, menta2, quinoa1, peperina2, menta1))
        ...
        it("No tiene parcelas sustentables") {
            inta3.masSustentable().shouldBe(beEmpty())
        }
